...
export default function IPhone16Pro() {
  return (
    <div className="bg-[#f4f4f5] relative size-full" data-name="iPhone 16 Pro - 3">
      <div className="absolute bg-gradient-to-b from-[#f4f4f5] from-[32.87%] h-[108px] left-1/2 to-[rgba(244, 244, 245,0)] top-0 translate-x-[-50%] w-[402px]" data-name="Status bar - iPhone" />
