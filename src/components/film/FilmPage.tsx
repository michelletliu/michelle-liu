...
const DEFAULT_FILM_PROJECT = {
  ...
  title: 'Film Diary',
  year: '2026',
  description: (<>A digital photo timeline, featuring scenes from <a href="https://sundays.rsvp" target="_blank" rel="noopener noreferrer" className="font-bold hover:text-gray-900 transition-colors">sundays in la</a>.</>),
