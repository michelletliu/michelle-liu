        ...
        {options.map((option) => {
          ...
          return (
            <button
              ...
              className={clsx(
                // 4px panel inset + 10px option padding.
                "flex items-center px-2.5 py-1 rounded-[10px] supports-[corner-shape:squircle]:rounded-[1.125rem] transition-colors text-left",
