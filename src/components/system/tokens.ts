...
export const colorGroups: ColorGroup[] = [
  {
    id: "grays",
    label: "Grays — the backbone",
    note: "The site's neutral scale (Tailwind gray-*). Muted #9ca3af is the single most-used color.",
    colors: [
      { name: "gray-900", value: "#111827", className: "text-gray-900", usage: "Project titles, emphasis body", tag: "canonical" },
      { name: "gray-800", value: "#1f2937", className: "text-gray-800", usage: "Modal tab labels, testimonial body", tag: "canonical" },
      { name: "gray-700", value: "#374151", className: "text-gray-700", usage: "Hero name, section headings, footer", tag: "canonical" },
      { name: "gray-600", value: "#4b5563", className: "text-gray-600", usage: "Active nav, body copy, metadata", tag: "canonical" },
      { name: "gray-500", value: "#6b7280", className: "text-gray-500", usage: "Secondary body, tool lists", tag: "canonical" },
      { name: "gray-400", value: "#9ca3af", className: "text-gray-400", usage: "Muted labels, captions, placeholders (most common)", tag: "canonical" },
      { name: "gray-300", value: "#d1d5db", className: "text-gray-300", usage: "Focus borders, quote underline, inactive badges", tag: "canonical" },
      { name: "gray-200", value: "#e5e7eb", className: "bg-gray-200", usage: "Shimmer base, card borders, spinners", tag: "canonical" },
      { name: "gray-100", value: "#f3f4f6", className: "bg-gray-100", usage: "Pill borders, hover fills, placeholders", tag: "canonical" },
      { name: "gray-50", value: "#f9fafb", className: "bg-gray-50", usage: "Button bg, section bg", tag: "canonical" },
  ...
  {
    id: "zinc-stone",
    label: "Zinc — secondary neutrals",
    note: "Used mostly in Film, Library, and dividers alongside the gray scale.",
    colors: [
      { name: "zinc-800", value: "#27272a", usage: "Film timeline active hashmark", tag: "canonical" },
      { name: "zinc-600", value: "#52525b", className: "text-zinc-600", usage: "Film info copy, Library spinner accent", tag: "canonical" },
      { name: "zinc-500", value: "#71717a", className: "text-zinc-500", usage: "Film loading hint", tag: "canonical" },
      { name: "zinc-200", value: "#e4e4e7", usage: "Film timeline idle hashmark, Library spinner ring", tag: "canonical" },
      { name: "zinc-100", value: "#f4f4f5", className: "bg-zinc-100", usage: "Divider lines, modal hero bands", tag: "canonical" },
    ],
  },
  {
    id: "accent",
    label: "Blue — the interactive accent",
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "Icon gray", value: "#c4c9d0", usage: "Footer social icons, community links", tag: "one-off" },
...
export const shadows: ShadowToken[] = [
  { name: "shadow-default", className: ".shadow-default", value: "0px 4px 16px 0px rgba(209,213,219,0.65)", usage: "Media cards, project link cards", tag: "canonical" },
  { name: "shadow-default-hover", className: ".shadow-default-hover", value: "0px 4px 16px 0px rgba(156,163,175,0.40)", usage: "Hover state on default-shadow cards", tag: "canonical" },
...
export const borders: ScaleToken[] = [
  ...
  { name: "border-gray-50", value: "#f9fafb", usage: "Image hairline overlays", tag: "canonical" },
  { name: "border-gray-100", value: "#f3f4f6", usage: "Cards, dropdowns, community frames", tag: "canonical" },
  { name: "border-zinc-100", value: "#f4f4f5", usage: "Project card frame", tag: "canonical" },
  ...
  { name: "focus outline", value: "2px solid #d1d5db, offset 2px", usage: "Global :focus-visible", tag: "canonical" },
  { name: "focus ring", value: "ring-2 ring-gray-400 offset-2", usage: "Cards & interactive tiles", tag: "canonical" },
];
...
export const materials: MaterialToken[] = [
  ...
  { name: "Glass nav pill", detail: "bg-gray-200/60 + backdrop-blur-md + triple inset shadow", usage: "Active nav tab", tag: "canonical" },
  ...
  { name: "Shimmer", detail: "Gradient #f3f4f6→#e5e7eb→#f9fafb, 2s ease-in-out loop", usage: "Image / skeleton loading", tag: "canonical" },
  { name: "Gradient text", detail: "violet/pink/blue/gray stops, animated 6s", usage: "Intro accent text", tag: "one-off" },
  ...
  { name: "Quote underline", detail: "#d1d5db 2px line, 0.6s reveal", usage: "Media quote cards", tag: "canonical" },
...
export const experiments: ExperimentIsland[] = [
  ...
  },
  {
    ...
    colors: [
      { value: "#1f2937", label: "active tick" },
      { value: "#d1d5db", label: "idle tick" },
      { value: "#9ca3af", label: "hover tick" },
    ],
  ...
  },
  {
    ...
    fonts: ["Michelle"],
    colors: [
      { value: "#111827", label: "body" },
      { value: "#9ca3af", label: "labels" },
