    ...
    >
      ...
      <div className="grid gap-x-6 gap-y-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm leading-snug text-zinc-400">Animated lavender → white, 8s drift</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm leading-snug text-zinc-400">
            bg-zinc-200/60 + backdrop-blur + inset shadow
          </p>
        </div>

        {/* Shimmer */}
        <div className="flex flex-col gap-3">
          <div className="flex h-28 items-center justify-center rounded-xl bg-zinc-50 ring-1 ring-inset ring-black/5">
            <div className="animate-shimmer h-16 w-32 rounded-xl" />
          </div>
          <p className="text-sm leading-snug text-zinc-400">Loading skeleton, 2s ease-in-out loop</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm leading-snug text-zinc-400">Availability dot + pulse ring</p>
        </div>

        {/* Edge fade */}
        <div className="flex flex-col gap-3">
          <div className="relative flex h-28 items-center justify-center overflow-hidden rounded-xl bg-zinc-200 ring-1 ring-inset ring-black/5">
            <div
          ...
          <p className="text-sm leading-snug text-zinc-400">Multi-stop white fade on carousels</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <span className="text-sm text-zinc-500">Grain overlay</span>
          </div>
          <p className="text-sm leading-snug text-zinc-400">PNG noise at opacity 0.8 over header</p>
        </div>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {materials.map((m) => (
          <div key={m.name} className="flex flex-col gap-1 rounded-xl bg-zinc-50/70 px-4 py-3.5">
            <div className="flex items-center justify-between gap-2">
              <span className="text-base font-medium text-zinc-700">{m.name}</span>
              <TagChip tag={m.tag} />
            </div>
