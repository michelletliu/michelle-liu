...
export default function RadiusSection() {
  return (
    ...
    >
      <div className="mb-10 rounded-2xl bg-gray-50 p-6">
        <h3 className="text-sm font-medium text-gray-500">
          Squircle corner-shape
        </h3>
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-gray-500 text-pretty">
          When a browser supports <code className="font-mono text-gray-400">corner-shape: squircle</code>,
          <code className="font-mono text-gray-400"> index.css</code> applies it globally and{" "}
          ...
          <code className="font-mono text-gray-400">corner-shape: round</code>. The samples below are
      ...
      <Grid min="170px">
        {radii.map((r) => (
          <TokenCard
            ...
            sample={
              <div
                className="h-16 w-16 bg-white ring-1 ring-inset ring-gray-200"
