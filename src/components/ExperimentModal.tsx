...
function SundaysEmbed({ project, isFullscreen = false, onCollapse }: { project: ExperimentProject; isFullscreen?: boolean; onCollapse?: () => void }) {
  ...
  return (
    <div className={clsx(
      ...
      isFullscreen ? 'min-h-screen items-center px-6 py-16 md:px-16 md:py-20' : 'min-h-full px-8 py-32 md:px-[8%] xl:px-[175px]'
    )}>
      {isFullscreen && (
        <button
      ...
      <div className={clsx(
        ...
        <header className="flex flex-col">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="hidden md:flex flex-wrap gap-0.5 shrink-0">
              <a
