...
/**
 * Instant About shell for soft navigations. Without this, App Router holds the
 * previous page (Work) until the /about RSC + client chunk are ready — which
 * felt like the tab was stuck when the pill had already slid to About.
 */
    ...
    <div className="flex min-h-screen w-full flex-col items-center bg-white">
      ...
      <div className="w-full px-16 max-md:px-6 pb-4">
        <div className="flex gap-1">
          ...
          <div className="h-9 w-12 rounded-full bg-zinc-50" />
          <div className="h-9 w-16 rounded-full border border-white/50 bg-zinc-200/60" />
        </div>
